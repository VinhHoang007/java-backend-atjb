        ...
        <div class="content">
             ...
             <div class="row content-create-post">
                <div class="col-9 pl-3">
                     ...
                     <form action="updatePost" method="post" modelAttribute="postUpdate">
                        <input type="hidden" name="id" value="<%=request.getParameter("postID")%>" class="form-control" > 
                        <input type="hidden" name="oldCreateTime" value="${createTime}" class="form-control" >
                         <div class="form-group form-create-post">
                            <label for="">Title <span class="requid">*</span></label>
                            <input type="text" name="title" value="${postEntiUp.title}" class="form-control">
                            <label for="">content <span class="requid">*</span></label>
                            <textarea name="content" id="" cols="66" rows="6">${postEntiUp.content}</textarea>
                            <small id="helpId" class="text-muted">You may use <a href="">Markdown systax</a></small>
                            <label for="">Tags</label>
                            <input type="text" name="tags" id="" style="width: 66%;" class="form-control"value="${postEntiUp.tags}">
                            ...
                            <select style="width: 20%;" class="mb-3" name="status">
