...
Kết hợp thêm Hibernate vào project ở bước :
+ 2.3
+ 5.3.3
+ 6.2.1 , 6.2.2
...
2. Chỉnh sửa pom.xml => Update Maven
    ...
    2.3. Add thư viện Hibernate, mssql-jdbc, spring-orm
...
5. Config DispatcherServlet (Spring) : nằm ở web.xml
    ...
    5.3. Tạo file [-servlet.xml] tương ứng với các servlet đã định nghĩa
        ...
        5.3.3. Thêm các config về Hibernate
...
6. Tạo các Controllers | Services | Repositories cần thiết
    ...
    6.2. Ở Repositories : tạo các method để tương tác DB
        6.2.1. Khai báo các entities cần thiết
        6.2.2. Chỉnh sửa repository theo cách sử dụng Hibernate để get dữ liệu
...
Note :
@Transactional :
    + không có hiệu lực với getCurrentSession()
    + Có hiệu lực với openSession()
