        ...
        <div class="row header">
            <div class="col-12">
                <div class="row parent-list-header">
                    ...
                    <div class="col-1 icon-user"><a href="#" style="font-size:25px"><i class="fas fa-user-tie"></i><i
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <c:forEach var="ele"  items="${lstContent}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<c:url value = "/editContent"/>" class="ml-2"><i class="fas fa-edit"></i></a> 
                                                <a href="<c:url value = "/deleteContent"/>" class="ml-2"><i class="fas fa-trash-alt"></i></a>              
                                            </td>
                                        </tr>
                                    </c:forEach>
