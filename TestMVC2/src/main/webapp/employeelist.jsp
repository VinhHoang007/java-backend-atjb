...
<div class="container-fluid container-manager row">
        ...
        <div class="header d-flex col-12">
            ...
            <div class="func-header">
                ...
                <a href="http://localhost:8080/JWD_L_A101/login_view" class="logout"><i class="fas fa-sign-out-alt"></i> Logout</a>
            </div>
        </div>
        <!-- navigation -->
        <div class="navgation col-2 p-3 align-items-center">
            ...
            <div class="row emp-list align-items-center">
                <span class="col-1"></span>  <a href="http://localhost:8080/JWD_L_A101/list_employee"
                    class="col-8">Employee list</a>
            </div>
            <div class="row emp-list align-items-center">
                <span class="col-1"></span>  <a href="http://localhost:8080/JWD_L_A101/add.jsp"
            ...
            <table class="table">
                ...
                %>
                    <tr>
                        ...
                        <td>
                            <a href="/JWD_L_A101/update_delete_view?id=<%=empList.get(i).getEmployeeID()%>" style="text-decoration: none;">
